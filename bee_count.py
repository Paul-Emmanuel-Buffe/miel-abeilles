...
class MrBee:          
    ...
    def add_bee(self, simulation_id, generation, distance, parent_1, parent_2,
                chemin, n_generations, mutation_rate, elitisme_rate, crossover_method):
        """
        Enregistre une abeille et renvoie son ID.
        parent_1 et parent_2 sont les IDs des parents (entiers ou None).
        """
        bee_id = self.next_id
        self.next_id += 1
